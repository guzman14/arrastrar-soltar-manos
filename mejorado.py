...
objects = [VirtualObject(random.randint(100, 400), random.randint(100, 400), 100, 100, (random.randint(0,255), random.randint(0,255), random.randint(0,255))) for _ in range(5)]
